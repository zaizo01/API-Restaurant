        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TableStatus = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DishCapacity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderTableDishs", x => new { x.OrderId, x.TableId, x.DishId });
                    table.ForeignKey(
                        name: "FK_OrderTableDishs_Dishs_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderTableDishs_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderTableDishs_DishId",
                table: "OrderTableDishs",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderTableDishs_TableId",
                table: "OrderTableDishs",
                column: "TableId");
        }
